namespace Infrastructure.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    internal class CreateOrderException : Exception
    {
        private const string DefaultMessage = "Exchange order creation failed: the returned order is null.";

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderException"/> class with a default error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderException"/> class with a specified error message.
        /// </summary>
