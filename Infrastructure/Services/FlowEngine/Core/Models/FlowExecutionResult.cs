...
namespace Infrastructure.Services.FlowEngine.Core.Models
{
    public class FlowExecutionResult
    {
        ...
        public static FlowExecutionResult Success(Guid flowId, string message = null, object? data = null) =>
            new() { 
                FlowId = flowId, 
        ...
        public static FlowExecutionResult Paused(Guid flowId, string message = null, object? data = null) =>
            new() { 
                FlowId = flowId, 
