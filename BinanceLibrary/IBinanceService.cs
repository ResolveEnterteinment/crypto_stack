...
namespace BinanceLibrary
{
    ...
    {
        public Task<PlacedExchangeOrder> PlaceSpotMarketBuyOrder(string symbol, decimal quantity, Guid subscriptionId);
        public Task<PlacedExchangeOrder> PlaceSpotMarketSellOrder(string symbol, decimal quantity, Guid subscriptionId);
