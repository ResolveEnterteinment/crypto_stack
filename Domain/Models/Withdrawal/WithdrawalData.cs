...
namespace Domain.Models.Withdrawal
{
    public class WithdrawalData : BaseEntity
    {
        ...
        public string RequestedBy { get; set; } // User's identity (email, etc.)
        public decimal Amount { get; set; }
        public string Currency { get; set; }
        public string WithdrawalMethod { get; set; } // Bank, crypto, etc.
        public string WithdrawalAddress { get; set; } // Bank account or crypto address
        ...
        public string KycLevelAtTime { get; set; } // KYC level when withdrawal was requested
        public Dictionary<string, object> AuditTrail { get; set; } = new Dictionary<string, object>();
    }
}