// src/components/Subscription/AssetAllocationStep.tsx (enhanced)
...
const AssetAllocationStep: React.FC<AssetAllocationStepProps> = ({
    ...
    const ErrorDisplay = () => {
        ...
        return (
            <div className={`border-l-4 p-4 mb-6 ${isMinNotionalError
                ...
                <div className="flex">
                    <div className="flex-shrink-0">
                        <svg
                            className={`h-5 w-5 ${isMinNotionalError ? 'text-yellow-500' : 'text-red-500'
                                }`}
                            viewBox="0 0 20 20"
                            fill="currentColor"
                        >
                    ...
                    <div className="ml-3 flex-1">
                        <h3 className={`text-sm font-medium ${isMinNotionalError ? 'text-yellow-700' : 'text-red-700'
                            }`}>
                            {isMinNotionalError
                        ...
                        <p className={`mt-1 text-sm ${isMinNotionalError ? 'text-yellow-600' : 'text-red-600'
                            }`}>
                            {overallError}
                        </p>
                        {isMinNotionalError && (
    ...
    return (
        <div>
            ...
            <p className="text-gray-600 mb-6">
                ...
                Each asset has minimum order requirements that must be met.
            </p>
            ...
            {overallLoading ? (
                ...
                <AssetAllocationForm
                    ...
                    totalInvestmentAmount={formData.amount}
            ...
            {process.env.NODE_ENV === 'development' && enhancedAssets.length > 0 && (
                <div className="mt-6 p-4 bg-gray-100 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600">
                        ...
                        <p>Total investment amount: ${formData.amount}</p>
